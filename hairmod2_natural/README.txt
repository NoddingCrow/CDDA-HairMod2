...
To use: 
Copy the parent directory of this file into /cdda/data/mods, such that the final path reads /cdda/data/mods/hairmod2_natural/modinfo.json
Activate the mod "Crow's Hairstyles 2: Natural" from the New World mod list, or add "hairmod2_natural" to the Mods list for an existing world.
